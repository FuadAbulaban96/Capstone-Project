<?php
	$pick_city = $_GET['pick_city'];


    if ($_GET['pick_city'] == 'Tafielah') {
		echo   '<span class="current">Select Pick-up Location</span>
				<ul class="list">
				    <li data-value="" class="option selected disabled">Select Pick-up Location</li>
