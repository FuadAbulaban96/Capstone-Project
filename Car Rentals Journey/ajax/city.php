<?php
	...
	if ($_GET['city'] == 'Tafielah') {
		echo   '<span class="current">Select Location</span>
				<ul class="list">
				    <li data-value="" class="option selected disabled">Select Location</li>
		...
		echo   '<span class="current">Select Location</span>
				<ul class="list">
				    ...
				    <li data-value="Zahar" class="option"><option value="Zahar" >Zahar</option></li>
				</ul>';
	}elseif ($city == 'Maan') {
		echo   '<span class="current">Select Location</span>
				<ul class="list">
